...
export default function GestionExerciceExamen() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Alaina miaraka ny matiere sy ny cours rehetra avy any amin'ny API
                ...
                // Kajiana ny isan'ny cours mifanaraka amin'ny id-n'ny matiere tsirairay
                const matieresCalculees = dataMatieres.map(matiere => {
                    // Filtrena ny cours rehetra manana ny id an'ity matiere ity
                    const coursDeLaMatiere = dataCours.filter(c => {
                        // Jerevana raha id mivantana (1) na avy amin'ny matiere_details.id ny fifandraisana
                    ...
                    return {
                        ...matiere,
                        cours_count: coursDeLaMatiere.length // Tehirizina ny halavan'ny lisitra (length)
                    };
                });
                ...
                console.error("Hadisoana teo am-pitanana ny angon-drakitra:", err);
                setError("Tsy nahazoana valiny ny mpizara (API). Jereo ny fifandraisana na ny token-nao.");
            } finally {
                setLoading(false);
            }
        };
            ...
            <Box sx={{
                ...
                <Box sx={{ flex: 1, minWidth: '300px' }}>
                    <Typography variant="h4" fontWeight="800" color="#0f172a" sx={{ letterSpacing: '-0.5px' }}>
                        Gestion des Examens et Devoirs
                    </Typography>
                            ...
                            <Card sx={{
                                ...
                                <CardActions sx={{
                                    ...
                                    <Button
                                        ...
                                        component={Link}
                                        to={`/enseignant/details-examen-devoir/${matiere.id}`}
                                    >
                                        Voir les cours
                                    </Button>
                                </CardActions>
